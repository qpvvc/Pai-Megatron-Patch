...
SAVE_INTERVAL=1000
DATASET_PATH=/workspace/model/llama3_ts/datasets/qwen-datasets/qwenbpe/wudao_qwenbpe_text_document
VALID_DATASET_PATH=$DATASET_PATH
PRETRAIN_CHECKPOINT_PATH=/workspace/model/llama3_ts/datasets/Qwen2.5-7B
...
OUTPUT_BASEPATH=/workspace/model/Pai-Megatron-Patch/examples/qwen2_5
### OTHERS ###
